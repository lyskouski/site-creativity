...
<article class="el_content">
    ...
    <p class="indent"><?php echo sprintf($translate->sys('LB_TASK_AUDITOR_RULES'), \Defines\Payments::AUDIT) ?></p>
    <form method="POST" action="<?php echo $this->getUrl('dev/tasks/auditor/text', \Defines\Extension::JSON) ?>" class="indent ui" data-class="Request/Form" data-actions="init">
