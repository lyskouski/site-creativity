...
<article class="el_content">
    ...
    <form method="POST" action="<?php echo $this->getUrl('dev/tasks/translation/text', \Defines\Extension::JSON) ?>" class="indent ui" data-class="Request/Form" data-actions="init">
