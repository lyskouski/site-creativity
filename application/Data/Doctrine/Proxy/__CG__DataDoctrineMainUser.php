 ...
 */
class User extends \Data\Doctrine\Main\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Data\\Doctrine\\Main\\User' . "\0" . 'id', '' . "\0" . 'Data\\Doctrine\\Main\\User' . "\0" . 'username', '' . "\0" . 'Data\\Doctrine\\Main\\User' . "\0" . 'money', '' . "\0" . 'Data\\Doctrine\\Main\\User' . "\0" . 'cookie'];
        }
