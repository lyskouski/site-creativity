 ...
 */
class AccessAction extends \Data\Doctrine\Main\AccessAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Data\\Doctrine\\Main\\AccessAction' . "\0" . 'id', '' . "\0" . 'Data\\Doctrine\\Main\\AccessAction' . "\0" . 'permission', '' . "\0" . 'Data\\Doctrine\\Main\\AccessAction' . "\0" . 'access', '' . "\0" . 'Data\\Doctrine\\Main\\AccessAction' . "\0" . 'action'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessAction $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setAction(\Data\Doctrine\Main\Action $action = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setAccess(\Data\Doctrine\Main\Access $access = NULL)
    {
