 ...
 */
class Cron extends \Data\Doctrine\Main\Cron implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'id', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'status', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'updatedAt', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'evMinute', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'evHour', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'evDay', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'evMonth', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'evWeekDay', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'command', '' . "\0" . 'Data\\Doctrine\\Main\\Cron' . "\0" . 'title'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cron $proxy) {
