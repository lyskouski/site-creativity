 ...
 */
class Book extends \Data\Doctrine\Main\Book implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Data\\Doctrine\\Main\\Book' . "\0" . 'id', '' . "\0" . 'Data\\Doctrine\\Main\\Book' . "\0" . 'author', '' . "\0" . 'Data\\Doctrine\\Main\\Book' . "\0" . 'title', '' . "\0" . 'Data\\Doctrine\\Main\\Book' . "\0" . 'year', '' . "\0" . 'Data\\Doctrine\\Main\\Book' . "\0" . 'pages', '' . "\0" . 'Data\\Doctrine\\Main\\Book' . "\0" . 'content'];
        }
    ...
    public function setIsbn($id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsbn', [$id]);

        return parent::setIsbn($id);
    }
