 ...
 * BookReadHistory
 *
 * @ORM\Table(name="book_read_history_daily", indexes={@ORM\Index(name="brhd_updated_at", columns={"updated_at"}), @ORM\Index(name="brhd_book_read_id", columns={"book_read_id"}), @ORM\Index(name="brhd_content_id", columns={"content_id"})})
 * @ORM\Entity
 */
class BookReadHistoryDaily
{
    /**
     * @var integer
     *
