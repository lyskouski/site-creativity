    ...
    <form method="POST" class="ui" data-class="Modules/Person/Work" data-actions="init" action="<?php echo $this->getUrl($this->get('pattern'), \Defines\Extension::JSON) ?>">
        <section class="el_form indent">
            <aside class="right">
                ...
                <a class="button bg_button" href="<?php echo $this->getUrl($this->get('url') . '/description/' . $this->get('id')) ?>">
                    <?php echo $translate->sys('LB_PERSON_DESCRIPTION') ?>
                </a>
        ...
        <?php if ($this->get('firstPage')): ?>
        <section class="indent ui" data-class="Modules/Person/Work" data-actions="addFirstPage">
        <?php else: ?>
        ...
        <?php endif ?>
            ...
            <section class="center">
                ...
                <div class="button bg_button ui" data-class="Modules/Person/Work" data-actions="addPage"><?php echo $translate->sys('LB_ARTICLE_ADD_PAGE') ?></div>
            </section>
            <p class="indent">&nbsp;</p>
        </section>
    </form>
    ...
    <div class="hidden" >
        ...
        <footer id="ui-editPanel-bm">
            <code class="el_grid">
                ...
                <div class="left">&nbsp;</div>
                <div class="button left bg_note ui" title="<?php echo $translate->sys('LB_STYLE_PAGE_NEW') ?>" data-class="View/Popup/EditPanel" data-actions="apply" data-command="split">&homtht;</div>
                <div class="button left bg_note ui" title="<?php echo $translate->sys('LB_STYLE_PAGE_MRG') ?>" data-class="View/Popup/EditPanel" data-actions="apply" data-command="join">&ac;</div>
            </code>
        </footer>
